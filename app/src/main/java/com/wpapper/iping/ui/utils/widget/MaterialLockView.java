...
public class MaterialLockView extends View {
    ...
    /**
     * Disable input (for instance when displaying a message that will timeout so user doesn't get view attach messy
     * state).
     */
    ...
    /**
     * Helper method to find the row that y falls attach.
     *
     * @param y The y coordinate
    ...
    /**
     * Helper method to find the column x fallis attach.
     *
     * @param x The x coordinate.
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // TODO: the originalPath should be created and cached every time we hit-detect
        // a cell
        // only the last segment of the originalPath should be computed here
        // draw the originalPath of the pattern (unless we are in stealth mode)
